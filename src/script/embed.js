...
if (document.location.hostname != 'localhost' &&
    ...
    prefix = '//cloudfront-files-1.publicintegrity.org/apps/2017/03/shared-reductions/';
}
...
try {
    ...
    const el = document.getElementById('sharedReductions');
    ...
    if (el.tagName.toLowerCase() == 'div') {
        ...
        iframe.setAttribute('id','sharedReductions');
    ...
    document.getElementById('sharedReductions').innerHTML = `<img src="${prefix}${PKG_VERSION}/img/graphic-940.png"/>`;
}
